...
const CATEGORY_FALLBACKS: Record<string, string> = {
  'prehistoric': svg('<path d="M15 12L9 18"/><path d="M9 6l6 6"/><rect x="3" y="18" width="4" height="4" rx="1"/><path d="M14 3l4 4-2 2-4-4z"/>'),
  'neolithic': svg('<path d="M12 2C8 7 4 10 4 14a8 8 0 0 0 16 0c0-4-4-7-8-12z"/>'),
  'ancient': svg('<path d="M3 20L12 4l9 16"/><path d="M7 14h10"/>'),
  'classical': svg('<path d="M3 21h18"/><path d="M5 21V7l7-4 7 4v14"/><path d="M9 21v-6h6v6"/>'),
  'medieval': svg('<circle cx="12" cy="14" r="6"/><path d="M12 8V3"/><path d="M10 3h4"/><path d="M8 10l-2-2"/><path d="M16 10l2-2"/>'),
  'renaissance': svg('<path d="M2 18L18 6"/><circle cx="20" cy="4" r="2"/><path d="M8 12l-4 8"/><path d="M10 14l2 6"/>'),
  'enlightenment': svg('<rect x="2" y="12" width="12" height="8" rx="1"/><circle cx="19" cy="9" r="4"/><path d="M14 16h5"/>'),
  'industrial': svg('<path d="M4 15h16"/><path d="M4 19h16"/><circle cx="8" cy="19" r="2"/><circle cx="16" cy="19" r="2"/><path d="M6 15l2-8h8l2 8"/>'),
  'gilded-age': svg('<path d="M12 2a7 7 0 0 0-4 12.7V18h8v-3.3A7 7 0 0 0 12 2z"/><path d="M9 18h6"/><path d="M10 22h4"/>'),
  'modern-age': svg('<circle cx="12" cy="12" r="2"/><path d="M12 2a14 7 30 0 1 0 20"/><path d="M12 2a14 7 150 0 1 0 20"/><path d="M12 2a14 7 -90 0 1 0 20"/>'),
  'atomic-age': svg('<circle cx="12" cy="12" r="3"/><ellipse cx="12" cy="12" rx="10" ry="4"/><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(60 12 12)"/><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(120 12 12)"/><path d="M12 2v3"/><path d="M12 19v3"/>'),
  'space-age': svg('<path d="M12 2c-2 4-3 8-3 12h6c0-4-1-8-3-12z"/><path d="M9 14l-3 4h3"/><path d="M15 14l3 4h-3"/>'),
  'digital-age': svg('<rect x="5" y="5" width="14" height="14" rx="2"/><path d="M5 9H2"/><path d="M5 15H2"/><path d="M19 9h3"/><path d="M19 15h3"/>'),
}

export function getCategoryFallbackIcon(category: string): string {
  return CATEGORY_FALLBACKS[category] ?? CATEGORY_FALLBACKS['prehistoric']
}
